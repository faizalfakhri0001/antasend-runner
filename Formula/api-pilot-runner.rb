class ApiPilotRunner < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/faizalfakhri0001/antasend-runner/releases/download/api-pilot-runner-v1.2.1/api-pilot-runner-mac-arm64.tar.gz"
    sha256 "f4d5d7d1f7293180f5eb921434da837761ecebb9116740cbbe02362ed2b3efe5"
  else
    url "https://github.com/faizalfakhri0001/antasend-runner/releases/download/api-pilot-runner-v1.2.1/api-pilot-runner-mac-amd64.tar.gz"
